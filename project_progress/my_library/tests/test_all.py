import unittest
from my_library import send_email, attach_file, read_email_content, read_email_title, send_notification, sendSlackWebhook
...
class TestMyLibrary(unittest.TestCase):
    ...
    def test_send_email(self):
        ...
        result = send_email("kw9212@naver.com", "test subject", "test message")
    ...
    def test_attach_file(self):
        ...
        result = attach_file("kw9212@naver.com", "test subject", "test message", "sample_file.txt")
        self.assertTrue(result)
    ...
    def test_read_email_content(self):
        ...
        result = read_email_content("kw9212@naver.com")
    ...
    def test_read_email_title(self):
        ...
        result = read_email_title("kw9212@naver.com")
        self.assertIsNotNone(result)
    ...
    def test_send_email_with_attachment(self):
        ...
        email_address = "kw9212@naver.com"
